...
- [x] **Phase 9: ABOUT — Dynamic Rounded Redesign** — Asymmetric rounded About layout balancing climbing + professional background, served from dedicated `layouts/about/single.html` (completed 2026-05-03)
- [x] **Phase 10: GALLERY — Lightbox + Masonry + Captions** — Native `<dialog>` lightbox, CSS column-count masonry, frontmatter captions in author-controlled order (completed 2026-05-04)
